define([
    ...
    function(baseModel, Occupations) {
        return baseModel.extend({
            ...
            getArrayMappedOptions: function() {

                var is_a = [], is_for = [], height = [], sex = [], education = [], religion = [], star_sign = [], occupation = [],
                    income = [], hair_colour = [], eye_colour = [], body = [], ethnicity = [], smoke = [], screening = [], drink = [];

                _.each (this.getIsAOptions(), function(object, key) {
                    is_a[object.id] = object.humanised;
                });
                _.each (this.getIsForOptions(), function(object, key) {
                    is_for[object.id] = object.humanised;
                });
                _.each (Occupations, function(object, key) {
                    occupation[object.id] = object.title;
                });
                _.each (this.getHeightOptions(), function(object, key) {
                    height[object.id] = object.humanised;
                });
                _.each (this.getSexOptions(), function(object, key) {
                    sex[object.id] = object.humanised;
                });
                _.each (this.getEducationOptions(), function(object, key) {
                    education[object.id] = object.humanised;
                });
                _.each (this.getReligionOptions(), function(object, key) {
                    religion[object.id] = object.humanised;
                });
                _.each (this.getStarSignOptions(), function(object, key) {
                    star_sign[object.id] = object.humanised;
                });
                _.each (this.getIncomeOptions(), function(object, key) {
                    income[object.id] = object.humanised;
                });
                _.each (this.getHairColourOptions(), function(object, key) {
                    hair_colour[object.id] = object.humanised;
                });
                _.each (this.getEyeColourOptions(), function(object, key) {
                    eye_colour[object.id] = object.humanised;
                });
                _.each (this.getBodyOptions(), function(object, key) {
                    body[object.id] = object.humanised;
                });
                _.each (this.getEthnicityOptions(), function(object, key) {
                    ethnicity[object.id] = object.humanised;
                });
                _.each (this.getSmokeOptions(), function(object, key) {
                    smoke[object.id] = object.humanised;
                });
                _.each (this.getScreeningOptions(), function(object, key) {
                    screening[object.id] = object.humanised;
                });
                _.each (this.getDrinkOptions(), function(object, key) {
                    drink[object.id] = object.humanised;
                });
